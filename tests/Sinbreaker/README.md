...
11. With Full Send and no other AP discounts, check a first bunker costs 60 AP and
    its consecutive use costs 50. Check gun-to-bunker and bunker-to-gun sequences
    both qualify, movement between attacks preserves Full Send, and a new turn
    restores the first-use cost. Pile Bunker retains melee behaviour and unlimited
    uses with Ammo Cases or resupply. Drive By+ still requires ordinary movement,
    not the bunker relocation, and applies its next-attack discount normally.
