...
public static class Affinity
{
    ...
    // process and would break save persistence). Persisted keys hash UTF-16 characters,
    // rather than the UTF-8 bytes used by Stem sound identifiers.
...
public sealed class LeaderState
{
    ...
    public List<string> GrantedVehicleIds { get; set; } = [];
}
